...
class CurrentWeatherFragment : ScopedFragment(), KodeinAware {
    ...
    private fun updateTemperatures(temperature: Double, feelsLike: Double) {
        val unitAbbrevaiation = chooseLocalizedUnitAbbreviation("°C", "°F")
        textView_temperature.text = "$temperature$unitAbbrevaiation"
        textView_feels_like_temperature.text = "Feels like $feelsLike$unitAbbrevaiation"
    }
