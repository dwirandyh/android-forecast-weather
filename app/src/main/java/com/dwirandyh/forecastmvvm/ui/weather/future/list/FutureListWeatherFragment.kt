...
class FutureListWeatherFragment : ScopedFragment(), KodeinAware {
    ...
    private fun bindUI() = launch(Dispatchers.Main) {
        var futureWeatherEntries = viewModel.weatherEntries.await()
    ...
    // extension to convert List<UnitSpecificSimplefutureWeatherEntry> thats is interface to groupie recyclerview item
